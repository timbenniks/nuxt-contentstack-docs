...
Welcome to **Nuxt Contentstack** - a comprehensive and developer-friendly integration between the [Contentstack platform](https://www.contentstack.com) and [Nuxt](https://nuxt.com).

::callout{icon="i-lucide-sparkles" color="primary" title="Free Developer Accounts"}
**New to Contentstack?** Get started with a free [Contentstack Explorer account](https://www.contentstack.com/explorer) - perfect for development and testing! No credit card required.
::
...
- 🎓 **Academy Courses**: Learn Contentstack fundamentals with [Contentstack Academy](https://www.contentstack.com/academy/explore?filter=%5B%7B%22uid%22%3A%22developer%22%2C%22parentUid%22%3A%22audience%22%7D%5D) developer courses

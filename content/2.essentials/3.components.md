...
```vue [pages/custom-seo-mapping.vue]
<template>
...
Since we pass the `seoMeta` prop directly to Nuxt's `useSeoMeta`, you can use any of the 100+ supported meta tags including:

- **Basic Meta**: `title`, `description`, `keywords`
- **Open Graph**: `ogTitle`, `ogDescription`, `ogImage`, `ogUrl`, `ogType`
- **Twitter Cards**: `twitterCard`, `twitterSite`, `twitterCreator`, `twitterImage`
- **Advanced**: `canonical`, `robots`, `viewport`, `charset`
- **And many more...**

...
<div class="my-8">
<iframe 
  src="https://www.youtube-nocookie.com/embed/ni3mMmbFSfM" 
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
  allowFullScreen="true" 
  frameBorder="0" 
  height="100%" 
  referrerPolicy="strict-origin-when-cross-origin" 
  style="aspect-ratio: 16/9; width: 100%; border-radius: 0.5rem;" 
  width="100%">
</iframe>
</div>

::callout{icon="i-lucide-book-open"}
**Learn More**: Want to dive deeper into Modular Blocks? Check out the [Contentstack Academy course on Modular Blocks](https://www.contentstack.com/academy/courses/content-modeling/modular-blocks) for comprehensive training, or visit the [Contentstack documentation](https://www.contentstack.com/docs/developers/create-content-types/modular-blocks) for technical details.
::
...
The component can automatically set SEO metadata using Nuxt's native [`useSeoMeta`](https://nuxt.com/docs/4.x/api/composables/use-seo-meta). You can pass SEO directly, or auto-generate it from entry data.
...
The `seoMeta` prop accepts all [useSeoMeta options](https://nuxt.com/docs/4.x/api/composables/use-seo-meta), including Open Graph, Twitter Cards, and canonical URLs. Manual `seoMeta` values override auto-generated ones.
...
::callout{icon="i-lucide-info"}
**Auto-imports**: Nuxt 4 automatically imports exports from `/utils` files. Simply export your `componentMap` and use it directly - no imports needed!
::

#### Alternative: Using a Composable
